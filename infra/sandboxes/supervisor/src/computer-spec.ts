export const COMPUTER_IMAGE = process.env.COWORK_COMPUTER_IMAGE ?? "cowork/computer:local";
...
export function containerCreateOptions(input: ComputerCreateInput) {
  return {
    ...
    Labels: {
      "cowork.managed": "true",
      "cowork.botId": input.botId,
      "cowork.workspaceId": input.workspaceId,
    },
    ExposedPorts: { "6080/tcp": {} },
    HostConfig: {
      Binds: [`${input.homePath}:/home/cowork`],
      PortBindings: {
