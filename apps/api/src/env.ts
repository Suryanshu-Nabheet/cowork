import { resolveAuthSecret, resolveEncryptionKey, resolveSupervisorToken } from "@cowork/core";
...
export function loadEnv(source: NodeJS.ProcessEnv = process.env): AppEnv {
  ...
  return {
    ...
    defaultProvider: source.PI_DEFAULT_PROVIDER ?? "ollama",
    defaultModel: source.PI_DEFAULT_MODEL ?? "",
